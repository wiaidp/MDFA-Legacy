mvar.specfact <- function(x.acf)
{
  ...
  #	Inputs:	
  #		x.acf: an array containing the given p.d. sequence.  It has
  #			dimension N x (q+1) x N, where x.acf[,1,] corresponds
  #			to the zeroth coefficient matrix, x.acf[,2,] is the first
