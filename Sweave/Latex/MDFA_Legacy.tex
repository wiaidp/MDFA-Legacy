...
\[
 ...
 1 & \zeta_2 & \ldots & \ldots & \zeta_2^{d-1} \\
  ...
  \vdots & \vdots & \vdots & \vdots & \vdots \\
  0 & \ldots & \ldots & \ldots &  \binom \zeta_2^{d-m_1} \\
  \vdots & \vdots & \vdots & \vdots & \vdots \\
   1 & \zeta_r & \ldots & \ldots & \zeta_r^{d-1} \\
  0 &  1 & 2 \zeta_r & \ldots & (d-1) \zeta_r^{d-2} \\
  \vdots & \vdots & \vdots & \vdots & \vdots \\
  0 & \ldots & \ldots & \ldots &  \binom \zeta_r^{d-m_1} \end{array} \right] 
  \otimes 1_n   \,
...
\begin{Soutput}
              MDFA        MB
Series 1 1.6610612 1.7543690
Series 2 0.7172857 0.7737456
Series 3 0.1318901 0.1432357
Series 4 0.5268806 0.5707831
\end{Soutput}
\begin{Sinput}
> diag(bw.mdfa[[2]])
\end{Sinput}
\begin{Soutput}
[1] 1.7486403 0.7496676 0.1322477 0.5491668
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
              MDFA        MB
Series 1 1.6706771 1.7790455
Series 2 0.6888456 0.7678869
Series 3 0.1293054 0.1408034
Series 4 0.4917103 0.5478180
\end{Soutput}
\begin{Sinput}
> diag(bw.mdfa[[2]])
\end{Sinput}
\begin{Soutput}
[1] 1.6855749 0.6986004 0.1261514 0.4921376
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
            MDFA        MB
South 0.47796078 2.2077969
West  0.15944674 1.2772253
NE    0.02883497 0.2194089
MW    0.08250970 0.6088022
\end{Soutput}
\begin{Sinput}
> diag(bw.mdfa[[2]])
\end{Sinput}
\begin{Soutput}
[1] 0.60600171 0.19213669 0.03073721 0.09966216
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
                MDFA           MB
Series 1 0.005017786 0.0001571835
Series 2 0.042996638 0.0007411871
\end{Soutput}
\begin{Sinput}
> diag(bw.mdfa[[2]])
\end{Sinput}
\begin{Soutput}
[1] 0.005778395 0.050107627
\end{Soutput}
\end{Schunk}
...
\label{thm:wk-wh.coint}
 ...
 The WK filter $\Psi (L)$ and WH filter $\widehat{\Psi} (L)$ have
  ...
  and (\ref{eq:wiener-hopf}) respectively for $\omega$ such that
...
\bibitem{} McElroy, T. (2017). Multivariate seasonal adjustment, economic identities, and seasonal taxonomy. Journal of Business & Economic Statistics, 35(4), pp.611-625.
