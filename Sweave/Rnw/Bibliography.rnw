...
model to enforce stationarity. 
  {\it Journal of Statistical Computation and Simulation} {\bf 24}, 99--106.
  
\bibitem{}  Ansley, C. F. and P. Newbold (1979). Multivariate partial autocorrelations. 
  In Proceedings of the Business \& Economics Section,  349--353.
  American Statistical Association.

\bibitem{} Baxter, M., and King, R. G. (1999). Measuring business cycles: 
approximate band-pass filters for economic time series. {\it Review of
Economics and Statistics} {\bf 81}(4), 575--593.

\bibitem{} Bell, W. (1984). Signal extraction for nonstationary time series. 
 {\it The Annals of Statistics} {\bf 12}(2), 646--664.
...
\bibitem{} Christiano, L.J., and Fitzgerald, T.J.(2003). 
  The band pass filter.  {\it International Economic Review}
  {\bf 44}(2), 435--465.

\bibitem{} Golub, G. H., and Van Loan, C. F. (1996). {\it Matrix Computations.}
 Johns Hopkins University Press. Baltimore and London.


\bibitem{} Heaps, S.E. (2020). Enforcing stationarity through the prior in 
vector autoregressions. arXiv preprint arXiv:2004.09455.

\bibitem{} Hodrick, R., and Prescott, E. (1997). Postwar U.S. business cycles: an
empirical investigation. {\it Journal of Money, Credit, and Banking}
{\bf 29}, 1--16.

\bibitem{} Hosoya, Y., and Taniguchi, M. (1982). A central limit theorem 
for stationary processes and the parameter estimation of linear processes. 
{\it The Annals of Statistics}, 132--153.

\bibitem{} Koopman, S., Harvey, A., Doornik, J., and Shepherd, N. (2000).
{\it Stamp 6.0: Structural time series analyser, modeller, and predictor.}
London: Timberlake Consultant.

\bibitem{} L\"utkepohl, H. (2007).  New Introduction to Multiple Time Series Analysis. 
Springer-Verlag. 

\bibitem{} Maravall, A., and Caparello, G. (2004).  Program TSW: Revised reference manual. 
Working paper 2004, Research Department, Bank of Spain.  
...
\bibitem{} McElroy, T. (2017). Multivariate seasonal adjustment, economic identities, 
and seasonal taxonomy. Journal of Business \& Economic Statistics, 35(4), pp.611-625.
...
\bibitem{} McElroy, T. and Politis, D. (2020).  Time Series: A First Course with Bootstrap Starter.
...
\bibitem{} Stock, J.H. and Watson, M.W., (1988). Testing for common trends. Journal of the American statistical Association, 83(404), 1097-1107.
