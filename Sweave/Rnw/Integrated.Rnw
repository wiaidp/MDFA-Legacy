...
rendered stationary.  Such time series are called {\it integrated processes}.  This chapter discusses the  MDFA methodology for non-stationary processes, discussing how
