...
\hline
  ...
  Consumption &   \Sexpr{perf_null[1,1]} & \Sexpr{perf_null[1,2]} & 
    \Sexpr{perf_alt[1,1]}  &  \Sexpr{perf_alt[1,2]}    &  
    \Sexpr{perf_emp[1,1]} &   \Sexpr{perf_emp[1,2]} \\
  Imports	 &   \Sexpr{perf_null[2,1]} & \Sexpr{perf_null[2,2]} & 
    \Sexpr{perf_alt[2,1]}  &  \Sexpr{perf_alt[2,2]}    &  
    \Sexpr{perf_emp[2,1]} &   \Sexpr{perf_emp[2,2]} \\
\hline      
\end{tabular}
\end{table}
...
\hline
  Series 	 &  MDFA    &  MB  &  MDFA    &  MB    &  MDFA    &  MB   \\
  South &   \Sexpr{perf_null[1,1]} & \Sexpr{perf_null[1,2]} & 
    \Sexpr{perf_alt[1,1]}  &  \Sexpr{perf_alt[1,2]}    &  
    \Sexpr{perf_emp[1,1]} &   \Sexpr{perf_emp[1,2]} \\
  West	 &   \Sexpr{perf_null[2,1]} & \Sexpr{perf_null[2,2]} & 
    \Sexpr{perf_alt[2,1]}  &  \Sexpr{perf_alt[2,2]}    &  
    \Sexpr{perf_emp[2,1]} &   \Sexpr{perf_emp[2,2]} \\
  NE &   \Sexpr{perf_null[3,1]} & \Sexpr{perf_null[3,2]} & 
    \Sexpr{perf_alt[3,1]}  &  \Sexpr{perf_alt[3,2]}    &  
    \Sexpr{perf_emp[3,1]} &   \Sexpr{perf_emp[3,2]} \\
  MW	 &   \Sexpr{perf_null[4,1]} & \Sexpr{perf_null[4,2]} & 
    \Sexpr{perf_alt[4,1]}  &  \Sexpr{perf_alt[4,2]}    &  
    \Sexpr{perf_emp[4,1]} &   \Sexpr{perf_emp[4,2]} \\
\hline      
\end{tabular}
\end{table}
