...
> # For this replication exercise we have to define a second DFT 
> #   which is altered in frequency zero only 
...
\end{Sinput}
\begin{Soutput}
       MDFA original MDFA modified      DFA
lag 0        0.53821       0.54017  0.54017
lag 1        0.10039       0.10010  0.10010
lag 2        0.17419       0.17443  0.17443
lag 3        0.11221       0.11223  0.11223
lag 4        0.08075       0.08076  0.08076
lag 5        0.01972       0.01990  0.01990
lag 6        0.05718       0.05736  0.05736
lag 7       -0.03330      -0.03329 -0.03329
lag 8       -0.04889      -0.04887 -0.04887
lag 9       -0.03821      -0.03797 -0.03797
lag 10      -0.08752      -0.08781 -0.08781
lag 11       0.04178       0.04374  0.04374
\end{Soutput}
\end{Schunk}
The modified MDFA replicates DFA exactly, as desired. Also, the differences between original and modified MDFAs are marginal, as expected. In the following we shall always rely on the \emph{original} MDFA (unmodified DFTs), because frequency zero is tackled the right way. 
...
> dimnames(crit_mdfa)[[1]]<-c("MDFA criterion (original)",
+                             "DFA criterion","sample MSE")
> dimnames(crit_mdfa)[[2]]<-"MSE estimates"
> t(round(crit_mdfa,3))
\end{Sinput}
\begin{Soutput}
              MDFA criterion (original) DFA criterion sample MSE
MSE estimates                     0.314         0.315      0.322
\end{Soutput}
\end{Schunk}
\end{enumerate}
...
\begin{Soutput}
52     for (k in 1:(K)) {                                           
53         trffkt[k + 1] <- (b %*% exp((0+1i) * k * (0:(length(b) - 
54             1)) * pi/(K)))                                       
55     }                                                            
56     return(list(b = b, trffkt = trffkt))                         
57 }                                                                
\end{Soutput}
\end{Schunk}
\textbf{Remark}
...
DFA-MSE & 0.001846 & 0.016628 & 0.022848 & 0.000000 & 0.041322 \\ 
  Lambda=1, eta=0 & 0.003309 & 0.009137 & 0.031698 & 0.000000 & 0.044145 \\ 
  Lambda=2, eta=0 & 0.004462 & 0.006004 & 0.037849 & 0.000000 & 0.048315 \\ 
  Lambda=4, eta=0 & 0.006067 & 0.003383 & 0.045914 & 0.000000 & 0.055364 \\ 
  Lambda=8, eta=0 & 0.007909 & 0.001698 & 0.055062 & 0.000000 & 0.064669 \\ 
  Lambda=16, eta=0 & 0.009739 & 0.000777 & 0.064729 & 0.000000 & 0.075246 \\ 
  Lambda=32, eta=0 & 0.011398 & 0.000316 & 0.074365 & 0.000000 & 0.086079 \\ 
  Lambda=64, eta=0 & 0.012743 & 0.000113 & 0.082730 & 0.000000 & 0.095586 \\ 
  Lambda=128, eta=0 & 0.013712 & 0.000037 & 0.088780 & 0.000000 & 0.102529 \\ 
   \hline
\end{tabular}
