...
width = 6, height = 6)
par(mfrow=c(3,1))
plot(abs(DFT_1),type="l",axes=F,col="blue",main="|DFT|: b_1=-0.7",xlab="")
axis(1,at=1+0:6*len/12,labels=c("0","pi/6","2pi/6","3pi/6",
"4pi/6","5pi/6","pi"))
axis(2)
box()
...
axis(2)
box()
plot(abs(DFT_3),type="l",axes=F,col="blue",main="|DFT|: b_1=0.7",xlab="")
axis(1,at=1+0:6*len/12,labels=c("0","pi/6","2pi/6","3pi/6",
"4pi/6","5pi/6","pi"))
axis(2)
box()
...
ymin<-0
ymax<-max(abs_dft[,1])
plot(abs_dft[,1],type="l",axes=F,col="blue",main="|DFT|: b_1=-0.7",
...
box()
ymax<-max(abs_dft[,3])
plot(abs_dft[,3],type="l",axes=F,col="blue",main="|DFT|: b_1=0.7",
xlab="",ylim=c(ymin,ymax))
axis(1,at=1+0:6*len/12,labels=c("0","pi/6","2pi/6","3pi/6","4pi/6",
"5pi/6","pi"))
axis(2)
