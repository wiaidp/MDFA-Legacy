### R code from vignette source 'C:/wia_desktop/Projekte/2016/MDFA-Legacy/Sweave/Rnw/MDFA_Legacy.Rnw'
### Encoding: ISO8859-1
...
###################################################
### code chunk number 18: dfa_ms
###################################################
source(file=paste(path_MDFA.pgm,"control_default.r",sep=""))


###################################################
### code chunk number 19: exercise_dfa_ms_1
###################################################
...
###################################################
### code chunk number 20: exercise_dfa_ms_2
###################################################
...
###################################################
### code chunk number 22: exercise_dfa_ms_3
###################################################
for (i in 1:3)
{
...
###################################################
### code chunk number 23: exercise_dfa_ms_4
###################################################
...
###################################################
### code chunk number 28: z_dfa_ar1_output.pdf
###################################################
file = paste("z_dfa_ar1_amp_shift.pdf", sep = "")
cat("\\begin{figure}[H]")
cat("\\begin{center}")
...
###################################################
### code chunk number 39: z_mdfadfa_ar1_output.pdf
###################################################
...
###################################################
### code chunk number 41: exercise_dfa_ms_4
###################################################
...
###################################################
### code chunk number 43: z_dfa_ar1_output.pdf
###################################################
  library(Hmisc)
  require(xtable)
  #latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 44: Filter_revisions.Rnw:22-24
###################################################
...
###################################################
### code chunk number 47: Filter_revisions.Rnw:94-110
###################################################
# Generate series
set.seed(10)
len<-120
...
###################################################
### code chunk number 48: Filter_revisions.Rnw:113-133
###################################################
L<-13
...
###################################################
### code chunk number 49: Filter_revisions.Rnw:136-201
###################################################
...
###################################################
### code chunk number 50: z_dfa_ar1_amp_shift_Lag_0.pdf
###################################################
  file = paste("z_dfa_ar1_amp_shift_Lag_0.pdf", sep = "")
  cat("\\begin{figure}[H]")
  cat("\\begin{center}")
...
###################################################
### code chunk number 51: Filter_revisions.Rnw:244-256
###################################################
...
###################################################
### code chunk number 52: Filter_revisions.Rnw:259-264
###################################################
...
###################################################
### code chunk number 53: vintage_triangle
###################################################
  library(Hmisc)
  require(xtable)
  #latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 54: Filter_revisions.Rnw:305-323
###################################################
colo<-rainbow(len)
...
###################################################
### code chunk number 55: z_vintages.pdf
###################################################
  file = paste("z_vintages.pdf", sep = "")
  cat("\\begin{figure}[H]")
  cat("\\begin{center}")
...
###################################################
### code chunk number 56: Filter_revisions.Rnw:339-364
###################################################
...
###################################################
### code chunk number 57: z_vintages_2.pdf
###################################################
  file = paste("z_vintages_2.pdf", sep = "")
  cat("\\begin{figure}[H]")
  cat("\\begin{center}")
...
###################################################
### code chunk number 58: Filter_revisions.Rnw:385-398
###################################################
set.seed(12)
...
###################################################
### code chunk number 59: exercise_dfa_ms_4
###################################################
# Fully in sample
insample<-nrow(data_matrix_120)
# d=0 for stationary series: see default settings
...
###################################################
### code chunk number 61: Filter_revisions.Rnw:431-439
###################################################
...
###################################################
### code chunk number 62: Filter_revisions.Rnw:442-464
###################################################
...
###################################################
### code chunk number 63: z_vintages_mdfa.pdf
###################################################
  file = paste("z_vintages_mdfa.pdf", sep = "")
  cat("\\begin{figure}[H]")
  cat("\\begin{center}")
...
###################################################
### code chunk number 64: dfa_ms
###################################################
head(mdfa_analytic)


###################################################
### code chunk number 65: exercise_constraint
###################################################
# Filter length
L<-5
set.seed(1)
...
###################################################
### code chunk number 66: exercise_constraint
###################################################
# Level constraint
sum(b)-w
...
###################################################
### code chunk number 67: Constraints.Rnw:476-505
###################################################
# Generate series
#rm(list=ls())
set.seed(10)
...
###################################################
### code chunk number 68: exercise_mdfa_ms_1
###################################################
# Filter length
L<-13
# Fully in sample
...
###################################################
### code chunk number 69: z_mdfa_ar1_amp_shift_Lag_0_iF_i2F.pdf
###################################################
  file = paste("z_mdfa_ar1_amp_shift_Lag_0_iF_i2F.pdf", sep = "")
  cat("\\begin{figure}[H]")
  cat("\\begin{center}")
...
###################################################
### code chunk number 70: exercise_dfa_ms_2
###################################################
# Source the default (MSE-) parameter settings
source(file=paste(path_MDFA.pgm,"control_default.r",sep=""))
...
###################################################
### code chunk number 71: z_mdfa_ar1_amp_shift_Lag_0_iT_i2F.pdf
###################################################
  file = paste("z_mdfa_ar1_amp_shift_Lag_0_iT_i2F.pdf", sep = "")
  cat("\\begin{figure}[H]")
  cat("\\begin{center}")
...
###################################################
### code chunk number 72: exercise_dfa_ms_3
###################################################
# Source the default (MSE-) parameter settings
...
###################################################
### code chunk number 73: z_mdfa_ar1_amp_shift_Lag_0_iF_i2T.pdf
###################################################
  file = paste("z_mdfa_ar1_amp_shift_Lag_0_iF_i2T.pdf", sep = "")
  cat("\\begin{figure}[H]")
  cat("\\begin{center}")
...
###################################################
### code chunk number 74: exercise_mdfa_ms_4
###################################################
# Source the default (MSE-) parameter settings
source(file=paste(path_MDFA.pgm,"control_default.r",sep=""))
...
###################################################
### code chunk number 75: z_mdfa_ar1_amp_shift_Lag_0_iT_i2T.pdf
###################################################
  file = paste("z_mdfa_ar1_amp_shift_Lag_0_iT_i2T.pdf", sep = "")
  cat("\\begin{figure}[H]")
  cat("\\begin{center}")
...
###################################################
### code chunk number 76: exercise_dfa_ms_3
###################################################
# Source the default (MSE-) parameter settings
source(file=paste(path_MDFA.pgm,"control_default.r",sep=""))#b0_H0
...
###################################################
### code chunk number 77: z_mdfa_ar1_amp_shift_Lag_0_iF_i2T_Lag.pdf
###################################################
  file = paste("z_mdfa_ar1_amp_shift_Lag_0_iF_i2T_Lag.pdf", sep = "")
  cat("\\begin{figure}[H]")
  cat("\\begin{center}")
...
###################################################
### code chunk number 78: exercise_dfa_ms_4
###################################################
len_t<-100
...
###################################################
### code chunk number 79: ATS.Rnw:312-313
###################################################
head(dfa_analytic)


###################################################
### code chunk number 80: ATS.Rnw:316-317
###################################################
tail(dfa_analytic)


###################################################
### code chunk number 81: ATS.Rnw:346-348
###################################################
...
###################################################
### code chunk number 82: ATS.Rnw:352-369
###################################################
#rm(list=ls())
...
###################################################
### code chunk number 83: ATS.Rnw:371-385
###################################################
...
###################################################
### code chunk number 84: ATS.Rnw:387-390
###################################################
...
###################################################
### code chunk number 85: ATS.Rnw:392-406
###################################################
...
###################################################
### code chunk number 86: print_tab_cor
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 87: ATS.Rnw:426-451
###################################################
...
###################################################
### code chunk number 88: z_box_plot_amp_and_shift_cust_T_1.pdf
###################################################
...
###################################################
### code chunk number 89: ATS.Rnw:464-495
###################################################
# Plots
#colo<-c("red","blue")
...
###################################################
### code chunk number 90: z_dfa_cust_ats_out_1_T.pdf
###################################################
...
###################################################
### code chunk number 91: ATS.Rnw:527-531
###################################################
# Specify the etas
eta_vec<-0.3*0:6
...
###################################################
### code chunk number 92: ATS.Rnw:533-559
###################################################
#rm(list=ls())
# Specify the processes: ar(1) with coefficients -0.9,0.1 and 0.9
a_vec<-c(0.9,0.1,-0.9)
...
###################################################
### code chunk number 93: ATS.Rnw:561-564
###################################################
# Proceed to estimation
for_sim_obj<-for_sim_out(a_vec,len1,len,cutoff,L,mba,estim_MBA,L_sym,
             Lag,i1,i2,scaled_ATS,lambda_vec,eta_vec,anzsim,M,dif)
...
###################################################
### code chunk number 94: ATS.Rnw:566-582
###################################################
# Extract sample performances
# 1 ATS
...
###################################################
### code chunk number 95: print_tab_cor
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 96: ATS.Rnw:595-620
###################################################
...
###################################################
### code chunk number 97: z_box_plot_amp_and_shift_cust_S_1.pdf
###################################################
...
###################################################
### code chunk number 98: ATS.Rnw:633-646
###################################################
for (DGP in 1:length(a_vec))#DGP<-1
{
...
###################################################
### code chunk number 99: z_box_plot_coef_S_1.pdf
###################################################
...
###################################################
### code chunk number 100: ATS.Rnw:659-689
###################################################
# Plots
#colo<-c("red","blue")
# we select DFA-MSE (second series) and a customized 
...
###################################################
### code chunk number 101: z_dfa_cust_ats_out_1_S.pdf
###################################################
...
###################################################
### code chunk number 102: ATS.Rnw:723-727
###################################################
# Specify the etas
eta_vec<-c(0,1.8)
# Specify the fixed lambda
...
###################################################
### code chunk number 103: ATS.Rnw:729-755
###################################################
#rm(list=ls())
# Specify the processes: ar(1) with coefficients -0.9,0.1 and 0.9
a_vec<-c(0.9,0.1,-0.9)
...
###################################################
### code chunk number 104: ATS.Rnw:757-760
###################################################
# Proceed to estimation
for_sim_obj<-for_sim_out(a_vec,len1,len,cutoff,L,mba,estim_MBA,L_sym,
              Lag,i1,i2,scaled_ATS,lambda_vec,eta_vec,anzsim,M,dif)
...
###################################################
### code chunk number 105: ATS.Rnw:762-776
###################################################
# Extract sample performances
# 1 ATS
...
###################################################
### code chunk number 106: print_tab_cor
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 107: ATS.Rnw:791-819
###################################################
...
###################################################
### code chunk number 108: z_box_plot_amp_and_shift_cust_ST_1.pdf
###################################################
...
###################################################
### code chunk number 109: ATS.Rnw:832-861
###################################################
# Plots
#colo<-c("red","blue")
# we select DFA-MSE (second series) and a customized 
...
###################################################
### code chunk number 110: z_dfa_cust_ats_out_1_ST.pdf
###################################################
...
###################################################
### code chunk number 111: ATS.Rnw:885-889
###################################################
...
###################################################
### code chunk number 112: ATS.Rnw:891-901
###################################################
# Extract sample performances
# 1 ATS
...
###################################################
### code chunk number 113: ATS.Rnw:908-922
###################################################
DGP<-1
...
###################################################
### code chunk number 114: z_box_plot_amp_and_shift_cust_ST_1_scaled_unscaled.pdf
###################################################
...
###################################################
### code chunk number 115: print_tab_cor
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 116: print_tab_cor
###################################################
i_process<-1
library(Hmisc)
require(xtable)
...
###################################################
### code chunk number 118: ATS.Rnw:989-991
###################################################
...
###################################################
### code chunk number 120: ATS.Rnw:1066-1067
###################################################
source(file=paste(path_DFA.pgm,"functions_trilemma.r",sep=""))


###################################################
### code chunk number 121: ATS.Rnw:1071-1073
###################################################
...
###################################################
### code chunk number 122: ATS.Rnw:1075-1104
###################################################
# Specify the processes: ar(1) with coefficients -0.9,0.1 and 0.9
a_vec<-c(0.9,0.1,-0.9)
# Ordinary ATS-components
...
###################################################
### code chunk number 123: ATS.Rnw:1106-1109
###################################################
...
###################################################
### code chunk number 124: ATS.Rnw:1111-1119
###################################################
# Extract sample performances
amp_shift_mat_sim<-for_sim_obj$amp_shift_mat_sim
amp_sim_per<-for_sim_obj$amp_sim_per
...
###################################################
### code chunk number 125: ATS.Rnw:1132-1159
###################################################
...
###################################################
### code chunk number 126: z_box_plot_emp_per_perf_inout_2.pdf
###################################################
...
###################################################
### code chunk number 127: z_box_plot_emp_per_perf_mse_inout_2.pdf
###################################################
...
###################################################
### code chunk number 128: ATS.Rnw:1205-1240
###################################################
amp_shift_mat_sim<-for_sim_obj$amp_shift_mat_sim
amp_sim_per<-for_sim_obj$amp_sim_per
shift_sim_per<-for_sim_obj$shift_sim_per
...
###################################################
### code chunk number 129: z_dfa_cust_ats_mba_per_e.pdf
###################################################
...
###################################################
### code chunk number 130: ATS.Rnw:1271-1276
###################################################
# Second process
a1<-0.1
...
###################################################
### code chunk number 131: ATS.Rnw:1278-1287
###################################################
# target
cutoff<-pi/12
len1<-2000
...
###################################################
### code chunk number 132: ATS.Rnw:1289-1293
###################################################
...
###################################################
### code chunk number 133: ATS.Rnw:1301-1308
###################################################
...
###################################################
### code chunk number 134: z_curv_dfacust_leadind.pdf
###################################################
...
###################################################
### code chunk number 135: ATS.Rnw:1328-1337
###################################################
...
###################################################
### code chunk number 136: z_peak_cor_dfacust_leadind.pdf
###################################################
...
###################################################
### code chunk number 137: ATS.Rnw:1358-1365
###################################################
...
###################################################
### code chunk number 138: z_MSE_dfacust_leadind.pdf
###################################################
...
###################################################
### code chunk number 139: ATS.Rnw:1387-1406
###################################################
# Plots
...
###################################################
### code chunk number 140: z_dfa_cust_mdfa_leading_indicator.pdf
###################################################
...
###################################################
### code chunk number 141: dfa_ms
###################################################
head(mdfa_analytic)


###################################################
### code chunk number 142: ATS_multivariate.Rnw:208-227
###################################################
# Second process
a1<-0.1
...
###################################################
### code chunk number 143: ATS_multivariate.Rnw:229-233
###################################################
anzsim<-1
lambda_vec<-c(0,30)
eta_vec<-c(0,1)
...
###################################################
### code chunk number 144: ATS_multivariate.Rnw:235-237
###################################################
...
###################################################
### code chunk number 145: ATS_multivariate.Rnw:244-245
###################################################
tail(mdfa_analytic)


###################################################
### code chunk number 146: ATS_multivariate.Rnw:248-259
###################################################
...
###################################################
### code chunk number 147: ats_comp_mdfa_S
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 148: ATS_multivariate.Rnw:277-415
###################################################
...
###################################################
### code chunk number 149: z_amp_shift_mdfacust_leadind_S.pdf
###################################################
...
###################################################
### code chunk number 150: ATS_multivariate.Rnw:439-503
###################################################
colo<-rainbow(length(lambda_mdfa))
...
###################################################
### code chunk number 151: z_amp_shift_mdfacust_leadind_agg_S.pdf
###################################################
...
###################################################
### code chunk number 152: ATS_multivariate.Rnw:530-534
###################################################
# Customization settings DFA
...
###################################################
### code chunk number 153: ATS_multivariate.Rnw:536-552
###################################################
# Second process
a1<-0.1
# target
...
###################################################
### code chunk number 154: ATS_multivariate.Rnw:554-556
###################################################
cust_leading_obj<-mdfa_mse_leading_indicator_vs_dfa_customized(anzsim,a1,
    cutoff,L,lambda_vec,eta_vec,len1,len,i1,i2,Lag,lambda_mdfa,eta_mdfa)  
...
###################################################
### code chunk number 155: ATS_multivariate.Rnw:564-575
###################################################
ats_mat<-matrix(nrow=length(lambda_mdfa),ncol=5)
for (i in 1:length(lambda_mdfa))
{
...
###################################################
### code chunk number 156: ats_comp_mdfa_T
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 157: ATS_multivariate.Rnw:594-657
###################################################
colo<-rainbow(length(lambda_mdfa))
...
###################################################
### code chunk number 158: z_amp_shift_mdfacust_leadind_agg_T.pdf
###################################################
...
###################################################
### code chunk number 159: ATS_multivariate.Rnw:684-688
###################################################
# Customization settings DFA
lambda_mdfa<-c(0,30)
# Fix eta=0
...
###################################################
### code chunk number 160: ATS_multivariate.Rnw:690-706
###################################################
# Second process
a1<-0.1
# target
...
###################################################
### code chunk number 161: ATS_multivariate.Rnw:708-710
###################################################
cust_leading_obj<-mdfa_mse_leading_indicator_vs_dfa_customized(anzsim,a1,
    cutoff,L,lambda_vec,eta_vec,len1,len,i1,i2,Lag,lambda_mdfa,eta_mdfa)  
...
###################################################
### code chunk number 162: ATS_multivariate.Rnw:717-728
###################################################
ats_mat<-matrix(nrow=length(lambda_mdfa),ncol=5)
for (i in 1:length(lambda_mdfa))
{
...
###################################################
### code chunk number 163: ats_comp_mdfa_ST
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 164: ATS_multivariate.Rnw:747-811
###################################################
...
###################################################
### code chunk number 165: z_amp_shift_mdfacust_leadind_agg_ST.pdf
###################################################
...
###################################################
### code chunk number 166: ATS_multivariate.Rnw:834-854
###################################################
...
###################################################
### code chunk number 167: ATS_multivariate.Rnw:856-857
###################################################
len1<-2000


###################################################
### code chunk number 168: ATS_multivariate.Rnw:859-861
###################################################
cust_leading_obj<-mdfa_mse_leading_indicator_vs_dfa_customized(anzsim,a1,
    cutoff,L,lambda_vec,eta_vec,len1,len,i1,i2,Lag,lambda_mdfa,eta_mdfa)  
...
###################################################
### code chunk number 169: ATS_multivariate.Rnw:866-883
###################################################
...
###################################################
### code chunk number 170: z_curv_mdfacust_leadind_ST.pdf
###################################################
...
###################################################
### code chunk number 171: Replication.Rnw:7-9
###################################################
source(file=paste(path_DFA.pgm,"functions_trilemma.r",sep=""))
source(file=paste(path_MDFA.pgm,"mplot_func.r",sep=""))
...
###################################################
### code chunk number 172: Replication.Rnw:72-90
###################################################
# Sample length
len<-120
...
###################################################
### code chunk number 173: Replication.Rnw:108-139
###################################################
...
###################################################
### code chunk number 174: Replication.Rnw:142-143
###################################################
head(benchmark)


###################################################
### code chunk number 175: Replication.Rnw:177-197
###################################################
# Specify the processes: ar(1) with coefficients -0.9,0.1 and 0.9
a_vec<-c(0.9,0.1,-0.9)
# Specify the lambdas
...
###################################################
### code chunk number 176: Replication.Rnw:200-200
###################################################



###################################################
### code chunk number 177: Replication.Rnw:202-210
###################################################
# Unscaled ATS-components: see below for an activation of this option
scaled_ATS<-F
# Length of symmetric filter (will be used later)
...
###################################################
### code chunk number 178: Replication.Rnw:212-217
###################################################
...
###################################################
### code chunk number 179: Replication.Rnw:222-238
###################################################
# Extract sample performances
# 1 ATS
ats_sym<-for_sim_obj$ats_sym
...
###################################################
### code chunk number 180: Replication.Rnw:240-307
###################################################
# Plots
for (ki in 1:length(a_vec))   #ki<-1
{
...
###################################################
### code chunk number 181: z_replication_amp_shift_dfa_2.pdf
###################################################
...
###################################################
### code chunk number 182: z_replication_ats_dfa_2
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 183: Replication.Rnw:330-349
###################################################
...
###################################################
### code chunk number 184: z_replication_curv_peak_dfa_2.pdf
###################################################
...
###################################################
### code chunk number 185: z_replication_output_dfa_2.pdf
###################################################
...
###################################################
### code chunk number 186: Replication.Rnw:395-400
###################################################
...
###################################################
### code chunk number 187: Replication.Rnw:404-420
###################################################
# Extract sample performances
# 1 ATS
ats_sym<-for_sim_obj$ats_sym
...
###################################################
### code chunk number 188: Replication.Rnw:422-440
###################################################
...
###################################################
### code chunk number 189: z_replication_curv_peak_dfa_2_emp.pdf
###################################################
...
###################################################
### code chunk number 190: Replication.Rnw:453-471
###################################################
# Boxplots performance measures
#colo<-rainbow(dim(amp)[2]-1)
...
###################################################
### code chunk number 191: z_replication_curv_peak_dfa_2_emp_mse.pdf
###################################################
...
###################################################
### code chunk number 192: Replication.Rnw:504-538
###################################################
# Post WWII data
start_year<-1947 
...
###################################################
### code chunk number 193: Replication.Rnw:540-547
###################################################
...
###################################################
### code chunk number 194: z_us_real_log_gdp.pdf
###################################################
...
###################################################
### code chunk number 195: Replication.Rnw:591-592
###################################################
library(dlm)


###################################################
### code chunk number 196: Replication.Rnw:609-619
###################################################
# Post WWII data
start_year<-1947 
start_date=paste(start_year,"-01-01",sep="")
...
###################################################
### code chunk number 197: Replication.Rnw:622-645
###################################################
...
###################################################
### code chunk number 198: Replication.Rnw:647-653
###################################################
...
###################################################
### code chunk number 199: z_ss_uc0_t
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 200: Replication.Rnw:665-667
###################################################
...
###################################################
### code chunk number 201: Replication.Rnw:671-693
###################################################
...
###################################################
### code chunk number 202: z_us_real_log_gdp_comp.pdf
###################################################
...
###################################################
### code chunk number 203: Replication.Rnw:722-724
###################################################
# Data up to 2008
end_date<-"2007-12-31"
...
###################################################
### code chunk number 204: Replication.Rnw:726-732
###################################################
start_year<-1947 
start_date=paste(start_year,"-01-01",sep="")
end_year<-as.double(substr(end_date,1,4))
...
###################################################
### code chunk number 205: Replication.Rnw:734-736
###################################################
# Data up to Dec 2014
end_date<-"2014-11-30"
...
###################################################
### code chunk number 206: Replication.Rnw:738-744
###################################################
start_year<-1947 
start_date=paste(start_year,"-01-01",sep="")
end_year<-as.double(substr(end_date,1,4))
...
###################################################
### code chunk number 207: Replication.Rnw:747-760
###################################################
...
###################################################
### code chunk number 208: Replication.Rnw:762-764
###################################################
...
###################################################
### code chunk number 209: Replication.Rnw:766-768
###################################################
...
###################################################
### code chunk number 210: Replication.Rnw:771-777
###################################################
# get estimates for ARMA(2,0) part
...
###################################################
### code chunk number 211: z_ss_uc0_t_gr
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 212: Replication.Rnw:790-824
###################################################
...
###################################################
### code chunk number 213: z_us_real_log_gdp_comp_wgr.pdf
###################################################
...
###################################################
### code chunk number 214: Replication.Rnw:860-865
###################################################
K<-1000
omega_k<-pi*(0:K)/K
...
###################################################
### code chunk number 215: Replication.Rnw:867-881
###################################################
...
###################################################
### code chunk number 216: z_effective_length.pdf
###################################################
...
###################################################
### code chunk number 217: Replication.Rnw:915-917
###################################################
...
###################################################
### code chunk number 218: Replication.Rnw:919-927
###################################################
start_year<-1947
end_year<-as.double(substr(end_date,1,4))
start_date=paste(start_year,'-01-01',sep="")
...
###################################################
### code chunk number 219: Replication.Rnw:930-931
###################################################
source(file=paste(path_MBA.pgm,"state_space_trend_cycle_gdp.r",sep=""))


###################################################
### code chunk number 220: Replication.Rnw:933-949
###################################################
...
###################################################
### code chunk number 221: z_ss_uc0_t_gr_i2
###################################################
library(Hmisc)
require(xtable)
#latex(cor_vec, dec = 1, , caption = "Example of using latex to create table",
...
###################################################
### code chunk number 222: Replication.Rnw:964-977
###################################################
# Reorder models
...
###################################################
### code chunk number 223: z_us_real_log_gdp_comp.pdf
###################################################
...
###################################################
### code chunk number 224: Replication.Rnw:1013-1017
###################################################
...
###################################################
### code chunk number 225: Replication.Rnw:1019-1029
###################################################
...
###################################################
### code chunk number 226: z_us_real_log_gdp_detrended.pdf
###################################################
...
###################################################
### code chunk number 227: Replication.Rnw:1062-1067
###################################################
K<-1000
omega_k<-pi*(0:K)/K
...
###################################################
### code chunk number 228: Replication.Rnw:1069-1083
###################################################
...
###################################################
### code chunk number 229: z_us_real_log_gdp_detrended_spect.pdf
###################################################
...
###################################################
### code chunk number 230: Replication.Rnw:1119-1139
###################################################
cutoff_len_upper<-4
cutoff_len_lower<-20
...
###################################################
### code chunk number 231: Replication.Rnw:1141-1155
###################################################
...
###################################################
### code chunk number 232: Replication.Rnw:1158-1164
###################################################
...
###################################################
### code chunk number 233: Replication.Rnw:1167-1190
###################################################
...
###################################################
### code chunk number 234: z_us_real_log_gdp_detrended_amp_shift_bp.pdf
###################################################
...
###################################################
### code chunk number 235: Replication.Rnw:1205-1208
###################################################
...
###################################################
### code chunk number 236: Replication.Rnw:1210-1235
###################################################
...
###################################################
### code chunk number 237: z_us_real_log_gdp_detrended_filt_bp.pdf
###################################################
...
###################################################
### code chunk number 238: Replication.Rnw:1273-1279
###################################################
K<-1000
omega_k<-pi*(0:K)/K
...
###################################################
### code chunk number 239: Replication.Rnw:1281-1295
###################################################
...
###################################################
### code chunk number 240: z_us_real_log_gdp_detrended_spect_i2.pdf
###################################################
...
###################################################
### code chunk number 241: Replication.Rnw:1327-1349
###################################################
cutoff_len_upper<-4
cutoff_len_lower<-20
cutoff_upper<-pi/cutoff_len_upper
...
###################################################
### code chunk number 242: Replication.Rnw:1351-1366
###################################################
# Additional configuration settings for MDFA
d<-0
lambda_cross<-lambda_smooth<-0
...
###################################################
### code chunk number 243: Replication.Rnw:1369-1375
###################################################
# Estimate MDFA MSE filter coefficients  
mdfa_obj<-mdfa_analytic(K,L,lambda,weight_func,Lag,Gamma,
              eta,cutoff,i1,i2,weight_constraint,lambda_cross,
...
###################################################
### code chunk number 244: Replication.Rnw:1378-1401
###################################################
...
###################################################
### code chunk number 245: z_us_real_log_gdp_detrended_amp_shift_bp_i2.pdf
###################################################
...
###################################################
### code chunk number 246: Replication.Rnw:1416-1421
###################################################
...
###################################################
### code chunk number 247: Replication.Rnw:1423-1448
###################################################
...
###################################################
### code chunk number 248: z_us_real_log_gdp_detrended_filt_bp_i2.pdf
###################################################
...
###################################################
### code chunk number 249: Replication.Rnw:1512-1514
###################################################
# Call HP-routines
library(mFilter)
...
###################################################
### code chunk number 250: Replication.Rnw:1527-1537
###################################################
# Load full data-set
start_year<-1960
end_date<-format(Sys.time(), "%Y-%m-%d")
...
###################################################
### code chunk number 251: Replication.Rnw:1540-1542
###################################################
...
###################################################
### code chunk number 252: Replication.Rnw:1546-1559
###################################################
# Data: US-GDP
x<-lgdp
# Series length
...
###################################################
### code chunk number 253: Replication.Rnw:1564-1592
###################################################
...
###################################################
### code chunk number 254: z_HP_us_real_log_gdp.pdf
###################################################
...
###################################################
### code chunk number 255: Replication.Rnw:1605-1643
###################################################
...
###################################################
### code chunk number 256: z_HP_filt_trffkt.pdf
###################################################
...
###################################################
### code chunk number 257: Replication.Rnw:1657-1707
###################################################
...
###################################################
### code chunk number 258: z_HP_filt_coef.pdf
###################################################
...
###################################################
### code chunk number 259: Replication.Rnw:1720-1721
###################################################
head(mplot)


###################################################
### code chunk number 260: Replication.Rnw:1724-1730
###################################################
...
###################################################
### code chunk number 261: Replication.Rnw:1789-1838
###################################################
...
###################################################
### code chunk number 262: z_HP_us_real_log_gdp_hp_diff__gap_amp.pdf
###################################################
...
###################################################
### code chunk number 263: Replication.Rnw:1858-1861
###################################################
...
###################################################
### code chunk number 264: Replication.Rnw:1864-1884
###################################################
# Select lambda
lambda<-200
# proceed to filtering
...
###################################################
### code chunk number 265: Replication.Rnw:1888-1909
###################################################
L<-50
...
###################################################
### code chunk number 266: Replication.Rnw:1912-1918
###################################################
# Check first-order: should give 1
print(paste("Transfer function in frequency zero: ",
...
###################################################
### code chunk number 267: Replication.Rnw:1922-1937
###################################################
...
###################################################
### code chunk number 268: z_HP_us_real_log_gdp_hp_diff_mse.pdf
###################################################
...
###################################################
### code chunk number 269: Replication.Rnw:1953-1966
###################################################
x_gap<-x
...
###################################################
### code chunk number 270: Replication.Rnw:1969-1977
###################################################
...
###################################################
### code chunk number 271: Replication.Rnw:1981-2009
###################################################
...
###################################################
### code chunk number 272: z_HP_us_real_log_gdp_hp_bp.pdf
###################################################
...
###################################################
### code chunk number 273: Replication.Rnw:2034-2048
###################################################
# Customization
lambda<-100
eta<-0.5
...
###################################################
### code chunk number 274: Replication.Rnw:2051-2063
###################################################
...
###################################################
### code chunk number 275: z_HP_cust_coef.pdf
###################################################
...
###################################################
### code chunk number 276: Replication.Rnw:2077-2099
###################################################
x_cycle_cust<-diff(x)
...
###################################################
### code chunk number 277: z_HP_us_real_log_gdp_hp_bp_cust.pdf
###################################################
...
###################################################
### code chunk number 278: Replication.Rnw:2114-2129
###################################################
...
###################################################
### code chunk number 279: z_HP_us_real_log_gdp_hp_bp_cust_1.pdf
###################################################
...
###################################################
### code chunk number 280: Replication.Rnw:2172-2207
###################################################
x<-lgdp
# Series length
len<-length(x)
...
###################################################
### code chunk number 281: Replication.Rnw:2210-2228
###################################################
...
###################################################
### code chunk number 282: z_amp_shift_dfa_mse_cf_0.pdf
###################################################
...
###################################################
### code chunk number 283: Replication.Rnw:2241-2247
###################################################
...
###################################################
### code chunk number 284: Replication.Rnw:2251-2259
###################################################
...
###################################################
### code chunk number 285: Replication.Rnw:2263-2269
###################################################
...
###################################################
### code chunk number 286: Replication.Rnw:2273-2280
###################################################
...
###################################################
### code chunk number 287: Replication.Rnw:2284-2295
###################################################
...
###################################################
### code chunk number 288: z_CF_us_real_log_gdp.pdf
###################################################
...
###################################################
### code chunk number 289: Replication.Rnw:2309-2331
###################################################
...
###################################################
### code chunk number 290: z_CF_us_real_log_gdp_fb.pdf
###################################################
...
###################################################
### code chunk number 291: Replication.Rnw:2345-2375
###################################################
# Filter length
L<-50
...
###################################################
### code chunk number 292: Replication.Rnw:2378-2391
###################################################
# Filter the data
...
###################################################
### code chunk number 293: Replication.Rnw:2394-2415
###################################################
#-------------
...
###################################################
### code chunk number 294: z_HP_us_real_log_gdp_cf_out.pdf
###################################################
...
###################################################
### code chunk number 295: Replication.Rnw:2429-2444
###################################################
# Plot the filtered outputs
...
###################################################
### code chunk number 296: z_HP_us_real_log_gdp_cf_cycle.pdf
###################################################
...
###################################################
### code chunk number 297: Replication.Rnw:2475-2492
###################################################
...
###################################################
### code chunk number 298: z_amp_shift_dfa_mse_cf.pdf
###################################################
...
###################################################
### code chunk number 299: Replication.Rnw:2512-2534
###################################################
# Filter length
L<-50
weight_func<-weight_func_cf  
...
###################################################
### code chunk number 300: Replication.Rnw:2581-2607
###################################################
...
###################################################
### code chunk number 301: z_HP_us_real_log_gdp_cf_out_cust.pdf
###################################################
